...
`octoprint_persist_terminal_command_history/translations`. When that folder exists,
an additional command becomes available:

babel_bundle --locale=<locale>
    Moves the translation for locale `<locale>` to octoprint_persist_terminal_command_history/translations,
